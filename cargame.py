...
def instruction():
    ...
    while J:
        ...
        message("Before playing, read the instructions:",black,-320,'med')
        message("Use the arrow directions to control the machine",yellow,-40,'med')
        message("The road has an oncoming, General and passing carriageway",yellow,-10,'med')
        ...
        message("If you hit a pedestrian, then you will be taken away points",red,110,'med')
        message("If you crash into a car or drive to the side of the road - you LOSE",red,140,'med')
        message("'B' for back",green,190,'med')
        pygame.display.update()
        for e in pygame.event.get():
